...
$remoteVirtualNetwork = Get-AzVirtualNetwork -Name "VNet1" -ResourceGroupName "magoni_vnet-rg"
...
$remoteVirtualNetwork = Get-AzVirtualNetwork -Name "VNet2" -ResourceGroupName "magoni_vnet-rg"
